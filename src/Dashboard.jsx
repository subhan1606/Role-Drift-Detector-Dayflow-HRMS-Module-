        ...
        <div className="container animate-fade-in" style={{ padding: '40px 24px' }}>
            ...
            <div className="flex-row justify-between" style={{ marginBottom: '32px' }}>
                ...
                <div className="flex-row">
                    <div className="flex-row" style={{ background: 'white', padding: '8px 16px', borderRadius: '8px', border: '1px solid #ddd', marginRight: '16px' }}>
                        ...
                        <input
                            ...
                            style={{ border: 'none', background: 'transparent', fontSize: '1rem', outline: 'none', width: '150px' }}
                        />
                            ...
                            <tbody>
                                {sortedEmployees.length > 0 ? (
                                    sortedEmployees.map(emp => (
                                        <tr key={emp.id} style={{ borderBottom: '1px solid #f9f9f9', cursor: 'pointer', background: selectedEmp?.id === emp.id ? 'var(--secondary-bg)' : 'transparent' }} onClick={() => setSelectedEmp(emp)}>
